...
<div class="wrap app-main">
  ...
  <h2>Plans</h2>
  <p>Family monthly is $14.99. Family yearly is $119.99. Every new circle includes a 14-day trial. After the trial the owner pays to keep checking new requests, inviting family, and using call-me. The trusted list and past checks stay readable. A paid plan is a family tool, not a stamp that a request is safe. When card payments are connected, the circle owner pays through Stripe. If payments are not connected, choosing a plan only records it on the circle.</p>
